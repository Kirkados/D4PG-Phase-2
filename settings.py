...
class Settings:
    ...
    RUN_NAME               = '50k_episode_noise_decay' # use just the name. If trying to restore from file, use name along with timestamp
    ...
    NOISE_SCALE_DECAY         = 0.999986137152479 # 0.9999 # 1 means the noise does not decay during training
