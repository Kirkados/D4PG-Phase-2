...
class Settings:
    ...
    RUN_NAME               = 'TEST_NEW_RUNWAY' # use just the name. If trying to restore from file, use name along with timestamp
    ...
    RECORD_VIDEO           = True
    VIDEO_RECORD_FREQUENCY = 2#20 # 20 Multiples of "CHECK_GREEDY_PERFORMANCE_EVERY_NUM_EPISODES"
