...
class Settings:
    ...
    RUN_NAME               = 'TEMP_slow_outdoor_12quad_1075proximity_nofail' # use just the name. If trying to restore from file, use name along with timestamp
    ...
    # Hyperparameters
    NUMBER_OF_ACTORS        = 10
    NUMBER_OF_EPISODES      = 8e6 # that each agent will perform
    MAX_TRAINING_ITERATIONS = 1e9 # of neural networks
